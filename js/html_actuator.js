...
HTMLActuator.prototype.message = function (won) {
  ...
  this.messageContainer.backgroundImage = 'url("img/go.jpg")';
   // this.messageContainer.getElementsByTagName("p")[0].innerHTML = "<p>" + message + "</p>" + "<img class=\"tile-picture\" src=\"img/go.jpg\" alt=\"\">"
};
